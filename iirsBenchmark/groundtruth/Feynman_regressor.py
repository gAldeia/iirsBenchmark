...
class Feynman_regressor(BaseEstimator, RegressorMixin):
    def __init__(self, *, equation_name, **kwargs):

        self.equation_name = equation_name

        feynmandata = feynmanPyData[equation_name]

        self.string_expression = feynmandata['string expression']
        self.latex_expression  = feynmandata['latex expression' ]
        self.expressible_by_IT = feynmandata['expressible by IT']
        self.python_function   = feynmandata['python function'  ]
...
Feynman_regressor.interpretability_spectrum = 'white-box'
Feynman_regressor.stochastic_executions = False
Feynman_regressor.grid_params = {
